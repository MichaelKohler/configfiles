...
var Logger = exports.Logger = function () {
  function Logger() {
    ...
    var dir = _path2.default.join(_os2.default.tmpdir(), 'graphql-language-service-logs');
    try {
    ...
    this._logFilePath = new _url.URL(_path2.default.join(dir, 'graphql-language-service-log-' + _os2.default.userInfo().username + '-' + getDateString() + '.log'), 'file://');
  ...
  Logger.prototype._log = function _log(message) {
    ...
    _fs2.default.appendFile(this._logFilePath.pathname, logMessage, function (error) {});
  };
